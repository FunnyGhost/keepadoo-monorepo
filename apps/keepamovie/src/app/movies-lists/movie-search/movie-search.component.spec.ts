...
describe('MovieSearchComponent', () => {
  ...
  test('should clear the results when leaving the search screen', () => {
    const movieSearchService = TestBed.inject(MovieSearchService);
    jest.spyOn(movieSearchService, 'clearSearchResults');

    component.ngOnDestroy();

    expect(movieSearchService.clearSearchResults).toHaveBeenCalled();
  });
});
